...
(function(){
    ...
    /*-----------------------------------------Đ ĐµĐ½Đ´ĐµÑ€ Đ¼Đ¸Đ½Đ¸ĐºĐ°Ñ€Ñ‚Ñ‹:END-----------------------------------------------*/
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-wrapper').length === 0){
            ...
            //Đ¡ĐºÑ€Ñ‹Đ²Đ°ĐµĐ¼ Đ½ĐµĐ´Đ¾ÑÑ‚Đ°Ñ‚ĐºĐ¸
			$(".tosBox").hide();
            $(".agario-promo").hide();
			...
			$('#setka').replaceWith ('<div id="setka" style="width:160px;height:160px;position:fixed;bottom:10px;right:10px;"><table width="100%" height="100%" style="border-spacing: 0px; font: 10px );')
        $('#setka').append ('<img src="./minimap.png" style="width:160px;height:160x;">');
        ...
        //ĐĐ±Ñ€Đ°Đ±Đ¾Ñ‚Ñ‡Đ¸Đº Đ¼Đ¸Đ½Đ¸-ĐºĐ°Ñ€Ñ‚Ñ‹
        if (render_timer === null)
            render_timer = setInterval(miniMapRender, 1000 / 10);

        //ĐŸĐ¾Đ·Đ¸Ñ†Đ¸Ñ Đ¼Đ¸Đ½Đ¸-ĐºĐ°Ñ€Ñ‚Ñ‹
